 ...
 *    
 *    Roadmap:
 *    - Photo sensor functionality to open and close door automatically 
 *      on a preset threshold of dawn and dusk.  Push buttons would then
 *      be a manual override rather than the primary controller.
 *    - Add supplemental heating control for brooder or over-winter extreme
 *      cold conditions.
 *    - Water and food alerts.  Light and/or email notification on low 
 *      water, low food levels, low and high temp.
 *    - Data logging.  Log indoor and outdoor temperature and humidity, 
 *      dusk, dawn, door acitivity
 */
